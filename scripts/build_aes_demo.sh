...
echo -e "${C_BLUE}[1/4] Synthesizing Formal Sail Specifications for all 8 VCPUs...${C_RESET}"
python3 "${ROOT_DIR}/tools/visa_synthesizer.py" --vcpu 8vcpu --output-dir "${EXAMPLES_DIR}"
