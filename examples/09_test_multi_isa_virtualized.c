...
static unsigned int __visa_program_compute_tier2_2[11]  = 
  {      600716985U,      1271091526U,      1307710948U,      981971725U, 
        4279546147U,      742856520U,      1192059758U,      1524232631U, 
        2934458453U,      2572014706U,      1598058523U};
static unsigned int __visa_program_compute_tier1_1[8]  = 
  {      76188692U,      1283621983U,      1619361638U,      50441065U, 
        4187530544U,      3152157947U,      2854755202U,      3122762061U};
...
static const unsigned char __vm_sbox_0[256] = {
    ...
    #define __VREG_ROT(r) (((unsigned int)(r) + 14U) & 0x3FU)
    #define __VREG_MASK(r) (0x26619fead6b0ULL + ((unsigned long long)__VREG_ROT(r) * 0x6c62272e07bb0142ULL))
    ...
    for (int __i = 0; __i < 128; __i++) {
        __vbank.__q[__i] = (0x26619fead6b0ULL + ((unsigned long long)__i * 0x6c62272e07bb0142ULL));
    }
    ...
    #define __VISA_DISPATCH() do { \
        ...
        unsigned int __slot = ((__pc * 7U) + 2U) % 8U; \
...
static const unsigned char __vm_sbox_0[256] = {
    ...
    #define __VREG_MASK(r) (0x7154c189a16eULL + ((unsigned long long)__VREG_ROT(r) * 0x517cc1b727220a95ULL))
    #define __VREG_GET(r) (__vbank.__q[__VREG_ROT(r)] ^ __VREG_MASK(r))
    #define __VREG_SET(r, val) do { __vbank.__q[__VREG_ROT(r)] = ((unsigned long long)(val)) ^ __VREG_MASK(r); } while(0)

    for (int __i = 0; __i < 128; __i++) {
        __vbank.__q[__i] = (0x7154c189a16eULL + ((unsigned long long)__i * 0x517cc1b727220a95ULL));
    }
    ...
    #define __VISA_DISPATCH() do { \
        ...
        unsigned int __slot = ((__pc * 53U) + 8U) % 11U; \
        __raw = __vbc_live[__slot]; \
...
{ 
  int r1 ;
  int __attribute__((__annotate__("vectis:visa:VCPU1_Arch")))  tmp ;
  int r2 ;
  int __attribute__((__annotate__("vectis:visa:VCPU2_Arch")))  tmp___0 ;
