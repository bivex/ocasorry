...
static unsigned int __visa_program_compute_tier2_2[8]  = 
  {      1991799607U,      1307613028U,      1089128533U,      3988739826U, 
        2216883747U,      1785139912U,      599667001U,      921032046U};
static unsigned int __visa_program_compute_tier1_1[8]  = 
  {      2854755202U,      1742871803U,      3986203952U,      50441065U, 
        1619361638U,      1283621983U,      1619692564U,      3122762061U};
...
static const unsigned char __vm_sbox_0[256] = {
    ...
    #define __VREG_MASK(r) (0x734a633015c1ULL + ((unsigned long long)__VREG_ROT(r) * 0x9e3779b97f4a7c15ULL))
    ...
    for (int __i = 0; __i < 128; __i++) {
        __vbank.__q[__i] = (0x734a633015c1ULL + ((unsigned long long)__i * 0x9e3779b97f4a7c15ULL));
    }
    ...
    #define __VISA_DISPATCH() do { \
        ...
        unsigned int __slot = ((__pc * 17U) + 4U) % 8U; \
...
static const unsigned char __vm_sbox_0[256] = {
    ...
    #define __VREG_MASK(r) (0x7006954ea676ULL + ((unsigned long long)__VREG_ROT(r) * 0x517cc1b727220a95ULL))
    #define __VREG_GET(r) (__vbank.__q[__VREG_ROT(r)] ^ __VREG_MASK(r))
    #define __VREG_SET(r, val) do { __vbank.__q[__VREG_ROT(r)] = ((unsigned long long)(val)) ^ __VREG_MASK(r); } while(0)

    for (int __i = 0; __i < 128; __i++) {
        __vbank.__q[__i] = (0x7006954ea676ULL + ((unsigned long long)__i * 0x517cc1b727220a95ULL));
    }
    ...
    #define __VISA_DISPATCH() do { \
        if (__pc >= 8) goto __h_vret; \
        unsigned int __slot = ((__pc * 13U) + 2U) % 8U; \
        __raw = __vbc_live[__slot]; \
