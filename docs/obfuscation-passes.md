...
## 8. Basic Block Splitting (`BBSplit` Jitter Jumps)
...
## 9. Decentralized Tree Dispatcher & Decoy Hubs (`DecentDisp` Anti-VMTag)
...
## 10. Opcode Equalization & Histogram Smoothing (`OpcodeEqualize` Anti-DRLDO)
...
## 11. Dataflow-Entangled Anti-Slicing Computation (`AntiSlicing`)
...
## 12. Instruction Substitution (`InstrSubst` with Opcode Normalization)
...
## 13. Ghost Code Injection (`GhostCode` with Opcode Blending)
...
## 14. Instruction Permutation (`InstrPermute` via Def-Use Scheduling)
...
## 15. Algorithmic Paradigm Morphing (Loop $\to$ Tail-Recursion)
...
## 16. Diophantine Opaque Predicates
...
## 17. Live Range Splitting (`LiveRangeSplit`)
...
## 18. Constant Unfolding (`ConstUnfold`)
...
## 19. Stack Memory Aliasing (`StackAliasing` with S-Box)
...
## 20. Nested Multi-Layer VM (2-Tier Packed VM)
...
## 22. JIT Bytecode Machine Code Compilation (`Jitify`)
...
## 24. Anti-Disassembly (Junk Byte Desync)
...
## 25. Self-Checksumming (Hash Guards)
...
## 26. Timing Verification (Anti-Stepping)
...
## 28. Identifier Renaming & Symbol Hashing (`RenameSymbols`)
...
## 29. Source Directives Stripping (`StripDirectives`)
...
## 31. Call Graph Flattening (Indirect Call Routing)
...
## 32. Cross-Function Bogus Call Injection
...
## 33. Arithmetic Exception Flow (`SIGFPE`)
...
## 35. Multi-Threaded Race Implicit Flow
...
## 37. Lookup Table Arithmetic (LUT)
...
## 39. Struct Field Permutation & Padding
...
## 40. Pointer Swizzling & Pointer Masking
...
## 42. Dynamic / Math-Property Opaque Predicates
...
## 43. Bogus Control Flow (BCF Code Cloning & Mutation)
...
## 46. Indirect Jump Tables (Computed Dispatch)
...
## 49. High-Order Polynomial MBA & Invertible Affine Transformations (Anti-Z3)
...
## 50. Linear Mixed Boolean-Arithmetic (MBA)
...
## 51. Control Flow Flattening (CFF)
...
## 52. Invariant Opaque Predicates
...
## 53. EncodeLiterals (String Literal Encryption)
...
## 54. Variable Splitting & Data Encoding (`EncodeData`)
...
## 55. C-Level Implicit Flow (Signals: SIGSEGV)
